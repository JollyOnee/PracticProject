...
class CameraRepository {
    ...
    suspend fun recognize(bitmap: Bitmap): String {
        android.util.Log.d("GROQ", "Key: '${BuildConfig.GROQ_API_KEY}'")
    ...
    ВАЖНО для интегралов: всегда используй фигурные скобки вокруг подынтегральной функции.
    Правильно: \int_{0}^{1}{x^2}dx
    Неправильно: \int_{0}^{1} x^2 dx
